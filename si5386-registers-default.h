/*
 * Si5386A Rev E Configuration Register Export Header File
 *
 * This file represents a series of Silicon Labs Si5386A Rev E 
 ...
 * ==============
 * Fvco = 14.7456 GHz
 * Fpfd = 1.9980487804878048... MHz [ 1 + 1023/1025 MHz ]
 * Fms0 = 491.52 MHz
 * Fms1 = 40 MHz
 * 
 * P dividers:
 ...
 *    N0:
 *       Value: 30
 *       OUT5: 245.76 MHz [ 245 + 19/25 MHz ]
 *       OUT6: 245.76 MHz [ 245 + 19/25 MHz ]
 *       OUT7: 245.76 MHz [ 245 + 19/25 MHz ]
 *    N1:
 *       Value: 368.64
 *       OUT0A: 10 MHz
 *       OUT0: 10 MHz
 ...
 *          Relative Static O/O Skew: 0 ps 
 * 
 *    N0_DELAY:                      0x0 0d (Twos compliment div 256)
 *    N0_IODELAY_STEP:               0x0 0d
 *    N0_IODELAY_COUNT:              0x0 0d
 *    N0_IODELAY_INC:                0x0
 *    N0_IODELAY_DEC:                0x0
 * 
 ...
 * VDD:      1.8 V
 * Ta:       25 C
 * Theta-JA: 22.0 °„C/W (JEDEC Board with 0 m/s airflow)
 * 
 * Condition                        On Chip Power  Overall Power  Ta    Tj   
 * -------------------------------  -------------  -------------  ----  -----
 * Typical Ta, Voltage, Current     916 mW         959 mW         25 C  45 C 
 * Worst-Case Ta, Voltage, Current  1.176 W        1.221 W        85 C  111 C
 * 
 *                             -----------------------  -----------------------
 *                                     Typical                Worst-Case       
 *                             -----------------------  -----------------------
 ...
 *         ----------  ------  -------  -------  -----  -------  -------  -----
 * VDD                             1.8      144    260      1.9      236    446
 * VDDA                            3.3      128    421      3.5      135    469
 * VDDO0A      10 MHz    LVDS      2.5       15     39      2.6       16     42
 * VDDO0       10 MHz    LVDS      2.5       15     39      2.6       16     42
 * VDDO1       Unused
 * VDDO2       Unused
 * VDDO3       Unused
 * VDDO4       Unused
 * VDDO5   245.76 MHz    LVDS      2.5       17     41      2.6       17     45
 * VDDO6   245.76 MHz    LVDS      2.5       17     41      2.6       17     45
 * VDDO7   245.76 MHz    LVDS      2.5       17     41      2.6       17     45
 * VDDO8       Unused
 * VDDO9       10 MHz    LVDS      2.5       15     39      2.6       16     42
 * VDDO9A      10 MHz    LVDS      2.5       15     39      2.6       16     42
 *                             -------  -------  -----  -------  -------  -----
 *                               Total      383    959    Total      488  1,221
 * 
 * Note:
 * 
 * -Tj is junction temperature. Tj must be less than 125 °„C (on Si5386 Revision E) for device to comply with datasheet specifications. Tj = Ta + Theta_JA*On_Chip_Power.
 ...
 * 0x003E[7:4]   LOS_MIN_PERIOD_EN           2                  0x2              
 ...
 * 0x013D[2:0]   OUT9A_MUX_SEL               1                  0x1              
 ...
 * 0x0212[47:0]  P1_NUM                      123                0x00000000007B   
 ...
 * 0x0302[43:0]  N0_NUM                      64424509440        0x00F00000000    
 * 0x0308[31:0]  N0_DEN                      2147483648         0x80000000       
 * 0x030C[0]     N0_UPDATE                   0                  0x0              
 * 0x030D[43:0]  N1_NUM                      1236950581248      0x12000000000    
 ...
 * 0x050E[5:0]   FASTLOCK_BW0_PLL            17                 0x11             
 * 0x050F[5:0]   FASTLOCK_BW1_PLL            37                 0x25             
 ...
 * 0x0532[23:0]  HOLD_15M_CYC_COUNT          835                0x000343         
 ...
 * 0x058B[19:0]  HSW_MEAS_SETTLE             22135              0x05677          
 ...
 * 0x059D[5:0]   HOLDEXIT_BW0                14                 0x0E             
 * 0x059E[5:0]   HOLDEXIT_BW1                31                 0x1F             
 ...
 * 0x05AD[15:0]  OUT_MAX_LIMIT_LMT           17895              0x45E7           
 * 0x05B1[15:0]  HOLD_SETTLE_TARGET          733                0x02DD           
 ...
 * 0x0A14[3]     N0_LOAD_AUTO_DIS            0                  0x0              
 ...
 * 0x0C03[3:0]   IN_CLK_VAL_PWR_UP_DIS       2                  0x2              
